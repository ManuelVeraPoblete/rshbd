...
$tra=new Nivel();
$datos=$tra->get_nivel_por_id($_GET["id"]);
if(sizeof($datos)==0)
{
        ...
        <div class="box-ingreso">
            ...
            <div class="panel-heading">
                <div class="btn-group pull-right">
                    <a href="Nivel.php" title="Agregar Usuario">
            ...
            <form method='post'>
                <table class='table  '>
                    <tr>
                        <td>Nombre Nivel</td>
                        <td><input type='text' name='Nivel' class='form-control' value="<?php echo $datos[0]["Nivel"];?>" required></td>
                    </tr>
                </table>

<?php
    ...
    require_once("../Paginacion/PaginacionLoteDevuelto.php")        ;
                                ...
                                foreach($datos as $dato)
                                {
                                    ...
                                    ?>
                                        <tr border=0>
                                            ...
                                            <td valign="top" ><?php echo $dato->Estado_Lote?></td>
                                            <td valign="top" ><?php echo $dato->Fecha_Estado?></td>
                                            <td>
                                                <a href="Aprueba_Lotes.php?id=<?php echo $dato->id;?>&Rev=S" title="Actualizar Lote">

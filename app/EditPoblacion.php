...
$tra=new Poblacion();
$datos=$tra->get_poblacion_por_id($_GET["id"]);
if(sizeof($datos)==0)
{
            ...
            <form method='post'>
                <table class='table  '>
                    <tr>
                        ...
                        <td><input type='text' name='Poblacion' class='form-control' value="<?php echo $datos[0]["Poblacion"];?>" required></td>
                    </tr>
                </table>

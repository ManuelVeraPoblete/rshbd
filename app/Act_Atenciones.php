<form class="form-horizontal" accept-charset="UTF-8" action="Atenciones.php"  method="post">
            ...
            <div class="tab-pane fade in active" id="Ide_Ciudadano">
                <div class="container" ng-controller="PhoneCtrl">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" disabled class="form-control" name="Nombre" value="<?php echo $datos[0]["Nombre"];?>"  placeholder="Ingrese Nombre Ciudadano" >
                        </div>
                    </div>
                    <div class="form-group">

...
$tra=new Modulo();
$datos=$tra->get_modulo_por_id($_GET["id"]);
if(sizeof($datos)==0)
{
        ...
        <div class="box-ingreso">
            ...
            <div class="panel-heading">
                <div class="btn-group pull-right">
                    <a href="Modulos.php" title="Agregar Usuario">
            ...
            <form method='post'>
                <table class='table  '>
                    <tr>
                        <td>Nombre Modulo</td>
                        <td><input type='text' name='Modulo' class='form-control' value="<?php echo $datos[0]["Modulo"];?>" required></td>
                    </tr>
                </table>

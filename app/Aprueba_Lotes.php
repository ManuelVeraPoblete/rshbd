                                                    ...
                                                    <ul class="col4"> 
                                                        ...
                                                        for ($i=0; $i < sizeof($datos_lote) ; $i++) { 
                                                            if ($Revision == "N") {
                                                                ...
                                                                if ( $datos_lote[$i]["Numero_Registro"] > 0 ) { ?>
                                                                    <li> <?php
                                                                        if ( $datos_lote[$i]["Est_Detalle_Id"] == 3 ) 
                                                                        { ?>
                                                                            <button type='button' class="btn" data-toggle="modal" >
                                                                               <span class="glyphicon glyphicon-remove" ></span> 
                                                                            </button>                                                                                                   
                                                                            ...
                                                                            <a href="Aprueba_Lotes.php?id_apr=<?php echo $datos_lote[$i]['Ld_id'];?>&Aprueba=Si&Rev=Si&Id_Cab=<?php echo $datos_lote[0]['id'];?>" title="Envia a Aprobacion">
                                                                                <button type='button' class="btn btn-success" data-toggle="modal" >
                                                                                    <span class="glyphicon glyphicon-ok" ></span> 
                                                                                </button>                                                                                                   
                                                                            </a> <?php

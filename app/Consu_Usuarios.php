<?php
    ...
    $titulo  = "Consulta Usuarios";$Genera  = "N"; $Grabar_Hojas = "N"; $Imp_Hoja = "N";
                    ...
                    <div class="panel-body">
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                <?php require_once("form/Menu_Consulta_Usuario.php") ;   ?>
                            </ul>
                        </div>
                        <?php 
                            if ($Genera == "N") { require_once("form/Form_Parametros_Consulta_Usuarios.php") ;  } 
                            else                { require_once("form/Muestra_Est_Atenciones_Ruta_Usuarios.php")      ;  }  
                        ?>
                    </div>
                </div>
            </div>

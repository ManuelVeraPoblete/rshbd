...
$tra=new Documento();
$datos=$tra->get_documento_por_id($_GET["id"]);
if(sizeof($datos)==0)
{
        ...
        <div class="box-ingreso">
            ...
            <div class="panel-heading">
                <div class="btn-group pull-right">
                    <a href="Documento.php" title="Agregar Usuario">
            ...
            <form method='post'>
                <table class='table  '>
                    <tr>
                        ...
                        <td><input type='text' name='Documento' class='form-control' value="<?php echo $datos[0]["Documento"];?>" required></td>
                    </tr>
                </table>

...
$tra=new Actividades();
$datos=$tra->get_actividades_por_id($_GET["id"]);
if(sizeof($datos)==0)
{
        ...
        <div class="box-ingreso">
            ...
            <div class="panel-heading">
                <div class="btn-group pull-right">
                    <a href="Actividades.php" title="Agregar Usuario">
            ...
            <form method='post'>
                <table class='table  '>
                    <tr>
                        ...
                        <td><input type='text' name='Actividades' class='form-control input-lg' value="<?php echo $datos[0]["Actividades"];?>" required></td>
                    </tr>
                </table>

                                                    ...
                                                    <ul class="col4"> 
                                                        ...
                                                        for ($i=0; $i < sizeof($datos_lote) ; $i++) { 
                                                            if ( $datos_lote[$i]["Numero_Registro"] > 0 ) { ?>
                                                                <li> <?php
                                                                    if ( $datos_lote[$i]["Est_Detalle_Id"] == 2 ) 
                                                                    { ?>
                                                                        <a href="Aprueba_Lotes_Digitacion.php?id_apr=<?php echo $datos_lote[$i]['Ld_id'];?>&Regreso=Si&Id_Cab=<?php echo $datos_lote[0]['id'];?>" title="Aprueba Digitacion">
                                                                        ...
                                                                        <a href="Aprueba_Lotes_Digitacion.php?id_apr=<?php echo $datos_lote[$i]['Ld_id'];?>&Aprueba=Si&Id_Cab=<?php echo $datos_lote[0]['id'];?>" title="Aprueba Digitacion">

                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="panel panel-primary filterable">
                                            <div class="panel-titulo">
                                                <h3 class="panel-title">Encabezado Lote</h3>      
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        if ( isset($datos_lote[0]["id"] ) ) { ?>
                                                            <label class="control-label col-lg-2" 
                                                                   for="email">Numero Lote:
                                                            </label>
                                                            <input type="text" 
                                                                   class="form-control" 
                                                                   name="Numero_Lote" 
                                                                   value="<?php echo $datos_lote[0]["Numero_Lote"];?>"   
                                                                   disabled>
                                                            <br>
                                                            <label class="control-label col-lg-2" 
                                                                   for="email">Fecha :
                                                            ...
                                                            <input type="date" 
                                                                   class="form-control" 
                                                                   name="Fecha_Lote" 
                                                                   value="<?php echo $datos_lote[0]["Fecha"];?>" 
                                                                   placeholder="Fecha de Lote" 
                                                                   disabled>
                                                            <br>
                                                            <label class="control-label col-lg-2" 
                                                                   for="email">Digitador:</label>
                                                            <input type="text" 
                                                                   class="form-control" 
                                                                   name="Nombre" 
                                                                   value="<?php echo  $datos_lote[0]["Nombre"].' '.$datos_lote[0]["Apellido"] ;?>"  
                                                                   disabled>
                                                            <?php
                                                        }  ?>
                                                    </div>
                                    ...
                                    <?php
                                        if ( isset($datos_lote[0]["id"] ) ) { ?>
                                            <div class="col-sm-8">
                                                <div class="panel panel-primary filterable">    
                                                    <div class="panel-titulo">
                                                        <h3 class="panel-title">Folios</h3>      
                                                    </div>
                                                    <ul class="col3"> 
                                                        <?php 
                                                        for ($i=0; $i < sizeof($datos_lote) ; $i++) { 
                                                            if ( $datos_lote[$i]["Numero_Registro"] > 0 ) { ?>
                                                                <li> <?php
                                                                    if ( $datos_lote[$i]["Est_Detalle_Id"] == 6 ) 
                                                                    { ?>
                                                                        <input type     ="text" 
                                                                               class    ="form-control" 
                                                                               name     ="Numero_Lote" 
                                                                               value    ="<?php echo $datos_lote[$i]["Numero_Registro"];?>" 
                                                                               disabled 
                                                                               style    ="display: -webkit-inline-box;">
                                                                        <a href="RecepcionaLote.php?id_apr=<?php echo $datos_lote[$i]['Ld_id'];?>&Aprueba=Si&Id_Cab=<?php echo $datos_lote[0]['id'];?>" title="Aprueba Digitacion">
                        ...
                        <center>
                            <div class="col-md-6">
                                <ul class="list-group">
                                    <a href="Recepcion_Lote_Archivo.php">

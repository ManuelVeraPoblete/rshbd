<?php
    ...
    $titulo  = "Estadisticas Hojas de Ruta  por Fecha";$Genera  = "N"; $Grabar_Hojas = "N"; $Imp_Hoja = "N";
    if (isset($_POST["Fecha_Desde"]) && isset($_POST["Fecha_Hasta"]))
    {
        $Fecha_Desde = $_POST["Fecha_Desde"] ; $Fecha_Hasta = $_POST["Fecha_Hasta"] ;
        $titulo  = "Estadisticas Hojas de Ruta desde el ".$Fecha_Desde." al ".$Fecha_Hasta;
        $Genera ="S";
    }
?>
<!DOCTYPE html>
                    ...
                    <div class="panel-body">
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                <?php require_once("form/Menu_Est_HojasRuta.php") ;   ?>
                            </ul>
                        </div>
                        <?php 
                            if ($Genera == "N") { require_once("form/Form_Parametros_Est_HojaRuta.php") ;  } 
                            else                { require_once("form/Muestra_Est_HojasRuta.php")      ;  }  
                        ?>
                    </div>
                </div>
            </div>

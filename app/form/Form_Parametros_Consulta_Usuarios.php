<form class="form-horizontal" accept-charset="UTF-8" action="Consu_Usuarios.php"  method="post">
            ...
            <center>
                <ul class="list-group">
                    <li class="list-group-item">
                        <button class="form-control btn btn-primary">Genera Consultas</button>   
                    </li>
                </ul>
            </center>
        </div>

        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="Ide_Ciudadano">
                    ...
                    <table class='table  '>
                        ...
                        <tr>
                            <td>Rut</td>
                            <td><input type="text"  class="form-control" name="Rut"  value=<?php echo $_POST["Rut_Ciudadano"] ;?> id="name" disabled placeholder="Nuevo Ingrese Rut Ciudadano" ></td>
                        </tr>
                        <tr>
                            <td>Nombre</td>
                            <td><input type="text"  class="form-control" name="Nombre"   placeholder="Ingrese Nombre Ciudadano" ></td>                            
                            <td>Apellido</td>
                            <td><input type="text"  class="form-control" name="Apellido"  placeholder="Ingrese Apellidos"></td>
                        </tr>
                        <tr>
                            <td>Telefono</td>
                            <td><input type="text"  class="form-control" name="Telefono"  placeholder="Numero de Telefono"></td>
                        </tr>
                        <tr>
                            <td>Poblacion</td>
                            <td>
                        ...
                        <tr>
                            <td>Numero</td>
                            <td><input type='text' name='Numero' class='form-control'  required  placeholder="Numero "></td>
                            <td>Block</td>
                            <td><input type='text' name='Block'  class='form-control'  required  placeholder="Numero de Block"></td>
                        </tr>
                        <tr>
                            <td>Departamento</td>
                            <td><input type='text' name='Departamento'  class='form-control'  required  placeholder="Numero de Departamento"></td>
                            <td>Casa</td>
                            <td><input type='text' name='Casa' class='form-control'  required  placeholder="Numero de Casa"></td>
                        </tr>
                        <tr>
                            <td>Referencia</td>
                            <td><input type="text"  class="form-control" name="Referencia"   placeholder="Ingrese Referencia Direccion" ></td>                                
                        </tr>
                    </table>

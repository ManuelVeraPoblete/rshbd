<?php
    ...
    $titulo  = "Resumen Diario de Atenciones";$Genera  = "N"; $Grabar_Hojas = "N"; $Imp_Hoja = "N";
                    ...
                    <div class="panel-body">
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                <?php require_once("form/Menu_Resumen_Atencion_Diario.php") ;   ?>
                            </ul>
                        </div>
                        <?php 
                            if ($Genera == "N") { require_once("form/Form_Parametros_Resumen_Atencion_Diaria.php") ;  } 
                            else                { require_once("form/Muestra_Atenciones_Diarias_Resumen.php")      ;  }  
                        ?>
                    </div>
                </div>
            </div>

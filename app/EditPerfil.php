...
$tra=new Perfil();
$datos=$tra->get_perfil_por_id($_GET["id"]);
if(sizeof($datos)==0)
{
        ...
        <div class="box-ingreso">
            ...
            <div class="panel-heading">
                <div class="btn-group pull-right">
                    <a href="Perfil.php" title="Agregar Usuario">
            ...
            <form method='post'>
                <table class='table  '>
                    <tr>
                        <td>Nombre Perfil</td>
                        <td><input type='text' name='Perfil' class='form-control' value="<?php echo $datos[0]["Perfil"];?>" required></td>
                    </tr>
                </table>

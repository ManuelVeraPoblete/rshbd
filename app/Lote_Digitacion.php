...
if ( isset($_GET["id"]) AND isset($_GET["Env"])) {
    ...
    $envia=$lote->Cambia_Estado_Lote_Detalle_Id_C($_GET["id"],$Estado);
} else { 
...
require_once("../Paginacion/PaginacionLote.php")        ;
                            ...
                            <tbody>
                                ...
                                foreach($datos as $dato)
                                {
                                    ...
                                    <tr border=0>
                                        ...
                                        <td>
                                            <?php 
                                            if (is_null($dato->Estado_Lote_Id)) { ?>
                                                <a href="AddLotes.php?id=<?php echo $dato->id;?>" title="Actualizar Lote">
                                        ...
                                        <td>
                                            <a href="ImpLotes.php?id=<?php echo $dato->id;?>" title="Imprimir Lote">
                                                <button type='button' class="btn btn-info" data-toggle="modal" >
                                        ...
                                        <td>
                                            <a href="ImpLotes.php?id=<?php echo $dato->id;?>" title="Digitacion">
                                                <button type='button' class="btn btn-info" data-toggle="modal" >
                                        ...
                                        <td>
                                            <?php 
                                            if (is_null($dato->Estado_Lote_Id)) { ?>
                                                <a href="Lote_Digitacion.php?id=<?php echo $dato->id;?>&Env=SI" title="Enviar a Digitacion">
                                                    <button type='button' class="btn btn-info" data-toggle="modal" >

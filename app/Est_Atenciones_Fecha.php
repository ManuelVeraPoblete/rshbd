                    ...
                    <div class="panel-body">
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                <?php require_once("form/Menu_Est_Atencion.php") ;   ?>
                            </ul>
                        </div>
                        <?php 
                            if ($Genera == "N") { require_once("form/Form_Parametros_Est_Atencion.php") ;  } 
                            else                { require_once("form/Muestra_Est_Atenciones.php")      ;  }  
                        ?>
                    </div>
                </div>
            </div>

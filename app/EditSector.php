...
$tra=new Sector();
$datos=$tra->get_sector_por_id($_GET["id"]);
if(sizeof($datos)==0)
{
        ...
        <div class="box-ingreso">
            ...
            <div class="panel-heading">
                <div class="btn-group pull-right">
                    <a href="Sector.php" title="Agregar Usuario">
            ...
            <form method='post'>
                <table class='table  '>
                    <tr>
                        <td>Nombre Sector</td>
                        <td><input type='text' name='Sector' class='form-control' value="<?php echo $datos[0]["Sector"];?>" required></td>
                    </tr>
                </table>

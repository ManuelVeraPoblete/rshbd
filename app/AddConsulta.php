...
<html>
    ...
    <body>
        ...
        <div class="box-ingreso">
            <h2>Crear Consultas</h2>
            <div class="panel-heading">
                <div class="btn-group pull-right">
                    <a href="Consulta.php" title="Agregar Usuario">
            ...
            <form name="form" action="" method='post' enctype="multipart/form-data">
                <table class='table  '>
                    <tr>
                        ...
                        <td><input type='text' name='Consulta' class='form-control' required></td>
                    </tr>
                    <tr>
                        <td>Nombre Corto</td>
                        <td><input type='text' name='Resumen' class='form-control' required></td>
                    </tr>
                </table>

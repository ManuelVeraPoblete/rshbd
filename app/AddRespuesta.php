...
<html>
    ...
    <body>
        ...
        <div class="box-ingreso">
            <h2>Crear Resultados de Encuestas </h2>
            ...
            <form name="form" action="" method='post' enctype="multipart/form-data">
                <table class='table  '>
                    <tr>
                        ...
                        <td><input type='text' name='Respuesta_Corta' class='form-control' required></td>
                    </tr>
                    <tr>
                        <td>Respuesta Larga</td>
                        <td><input type='text' name='Respuesta_Larga' class='form-control' required></td>
                    </tr>
                </table>

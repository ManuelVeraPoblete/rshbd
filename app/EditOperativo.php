...
require_once("../Clases/ClaseOperativo.php");
require_once("../Include/Rutinas.php")                  ;
$tra=new Operativo();
$datos=$tra->get_operativo_por_id($_GET["id"]);
if(sizeof($datos)==0)
{
...
<html>
    ...
    <body>
        ...
        <div class="box-ingreso">
            <h2>Editar Operativo</h2>
            <div class="panel-heading">
                <div class="btn-group pull-right">
                    <a href="Operativo.php" title="Agregar Usuario">
            ...
            <form method='post'>
                <table class='table  '>
                    <tr>
                        ...
                        <td><input type='text' name='Operativo' class='form-control' value="<?php echo $datos[0]["Operativo"];?>" required></td>
                    </tr>
                </table>

...
$cantidad_resultados_por_pagina=15;
    ...
    $sql1="select count(*) as cuantos from lote_cabeza;  ";
    ...
    $sql="SELECT  lote_cabeza.id , 
          ...
          INNER JOIN lote_detalle ON lote_detalle.Lote_Cabeza_Id = lote_cabeza.ID
          where lote_detalle.Estado_Detalle_Id = 4
          group by id
          ORDER BY id DESC
